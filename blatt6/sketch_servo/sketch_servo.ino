...
#define T_LEFT  31      //Taster links
#define T_RIGHT 33      //Taster rechts
#define XOUT  A8        //xout vom stick
#define YOUT  A9        //yout vom stick
#define T_J 47          //stick taster
#define LOWER_SERVO 2   //unterer Servo zum Schwenken
#define UPPER_SERVO 3   //oberer Servo zum Kippen
...
void TFTinit(void) {
        ...
        TFTwriteCommand(COLMOD);        //outputFileToSerial(text2.txt)
//outputFileToLCD(text2.txt)//RGB-format, color mode
...
void loop() {
  ...
  valY = bessereMap(valY, 0, 1023, 0.0, 3.3);
  Serial.print("Y: "); 
  Serial.println(valY);
  delay(3000);*/
}
